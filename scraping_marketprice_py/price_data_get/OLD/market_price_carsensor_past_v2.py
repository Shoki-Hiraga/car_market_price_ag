...
dataget_selectors = {
    "maker_name": "span.assessmentItem__carName",
    "model_name": "a.assessmentItem__grade",
    "grade_name": "p.assessmentItem__carInfoItem:nth-of-type(1) span",
    "year": "p:nth-of-type(2) span",
    "mileage": "span.assessmentItem__priceNum:nth-of-type(1)",
    "min_price": "span:nth-of-type(3)",
    "max_price": "span:nth-of-type(4)",  # 適切なセレクターに変更
    "sc_url": "url"  # これは固定値なのでそのまま
}

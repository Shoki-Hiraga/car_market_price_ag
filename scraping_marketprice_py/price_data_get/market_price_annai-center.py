...
import time
import random
from funciton_app.annai_center_dataget_selectors_edit import process_data
from db_handler import save_to_db, is_recent_url
from logs.logger import log_decorator, log_info, log_error 

# 定義: テーブル名
TABLE_NAME = "market_price_annai_center"

# pagenation_selectors のどこでページネーションさせるか指定
select_pagenation_selectors = 1

# Define parameters
website_url = "https://annai-center.com/kaitori/"
start_url = "https://annai-center.com/kaitori/"
pagenation_selectors = [
    # "div.makerShashuList:nth-of-type(1) a",
    "div.makerShashuList:nth-of-type(1) li:nth-of-type(1) a",
    ".chojin-car-index__item a",
    "a.jirei-box",   
]

dataget_selectors = {
    "maker_name": "td.table_desc:nth-of-type(1) a",
    "model_name": "tr:nth-of-type(1) td.table_desc:nth-of-type(2) a",
    "grade_name": "tr:nth-of-type(2) td:nth-of-type(2)",
    "year": "tr:nth-of-type(2) td:nth-of-type(1)",
    "mileage": "tr:nth-of-type(3) td:nth-of-type(2)",
    "min_price": ".item_price em",
    "max_price": ".item_price em",
    "sc_url": "url"
}
pagenations_min = 1
pagenations_max = 10
                ...
                if idx == select_pagenation_selectors:
                    for link in links:
                        for page_num in range(pagenations_min, pagenations_max + 1):
                            paginated_url = f"{link}?start={page_num}"

...
def get_claude_response(maker_name, model_name, prompt="500文字~2000文字で収まるように歴代モデルをHTMLで解説してください。適宜 h3見出しを使用し、class名は model_contents としてください。また改行も適宜するようにお願いします！", model_version="claude-3-5-sonnet-latest"):
    """

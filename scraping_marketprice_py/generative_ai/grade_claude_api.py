...
def get_claude_response(maker_name, model_name, grade_name, prompt="500文字~2000文字で収まるようにグレードの特徴をHTMLで解説してください。その際、適宜 h3見出しを使用し、 class名は model_contents としてください。", model_version="claude-3-5-sonnet-latest"):
    """
